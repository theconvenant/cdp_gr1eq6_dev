...
describe('US3_deleteProject', function () {
  ...
  it('us7_deleteProject', async function() {
    ...
    await driver.findElement(By.name("projectName")).sendKeys("deleteProject")
    await driver.findElement(By.name("description")).sendKeys("to be deleted")
