...
describe('US3_deleteProject', function () {
  ...
  it('us8_addUserToProject', async function() {
    ...
    await driver.findElement(By.name("projectName")).sendKeys("invite guest")
    await driver.findElement(By.name("description")).sendKeys("test for adding user to project")
